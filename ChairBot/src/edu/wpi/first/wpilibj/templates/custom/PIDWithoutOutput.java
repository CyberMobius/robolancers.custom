 ...
 * Edits by Eric:
 * 
 * 1. PIDController simply calculates the result but does not write it to
 * an output
 */
public class PIDWithoutOutput implements IUtility {
    ...
    private class PIDTask extends TimerTask {
        ...
        private PIDWithoutOutput m_controller;

        public PIDTask(PIDWithoutOutput controller) {
            if (controller == null) {
                throw new NullPointerException("Given PIDWithoutOutput was null");
            }
     ...
     * is 50ms.
     */
    public PIDWithoutOutput(double Kp, double Ki, double Kd,
            PIDSource source, double period) {
        ...
        m_controlLoop.schedule(new PIDWithoutOutput.PIDTask(this), 0L, (long) (m_period * 1000));
    }
    ...
    public PIDWithoutOutput(double Kp, double Ki, double Kd,
            PIDSource source) {
        this(Kp, Ki, Kd, source, kDefaultPeriod);
    }
    ...
    /**
     * Set the setpoint for the PIDWithoutOutput
     *
    ...
    /**
     * Returns the current setpoint of the PIDWithoutOutput
     *
    ...
    /**
     * Begin running the PIDWithoutOutput
     */
    ...
    /**
     * Stop running the PIDWithoutOutput, this sets the output to zero before
     * stopping.
     */
    ...
    /**
     * Return true if PIDWithoutOutput is enabled.
     */
     ...
     * 
     * Edit by Eric: Removed disable while resetting.
     */
